...
For the design and API of the shipped feature, see [Transparent HWND Overlay (Post-Weave Chroma-Key)](https://github.com/DisplayXR/displayxr-leia-plugin/blob/main/docs/chroma-key-overlay.md).
