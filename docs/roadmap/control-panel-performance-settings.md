...
| `DXR_HOLDER_STALL_MS` | `d3d11_service/comp_d3d11_service.cpp` (`dxr_holder_stall_ns`) | `getenv`, cached | 2000 | Svc | 3 | #939 holder liveness: an active `APP_HWND` holder with no present grant this long yields the panel to a live present-owner instead of showing black. `0` disables |
