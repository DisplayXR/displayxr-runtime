...
and tier. **76 distinct names**; the two `DXR_BG2D_*` knobs reach the environment through
...
As of this writing that yields **76** names, all present above. Read sites and mechanisms
