...
a verdict under 50% is **sticky**: the loop unlearns to +0, drops its window and needs three
consecutive covered verdicts to decide again. The first, per-epoch version of this gate
