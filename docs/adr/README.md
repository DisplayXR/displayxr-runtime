...
- [ADR-037](ADR-037-adapter-placement-policy-hybrid-devices.md) — Adapter placement on hybrid-GPU devices: render on the best render adapter, weave on scanout, runtime decides (PROPOSED)
