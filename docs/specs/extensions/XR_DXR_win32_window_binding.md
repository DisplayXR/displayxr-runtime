...
> zones + M 2D zones + a per-pixel wish mask); a `_texture` app gets identical capability
> through it (verified: `cube_zones_texture_d3d11_win` / `cube_zones_texture_d3d12_win` /
> `cube_zones_texture_metal_macos`).
