...
| Why `xrEnumerateViewConfigurationViews` can return 4 views for `PRIMARY_STEREO` (max-across-modes count, the spec deviation, its named CTS exclusion, the planned fix) | `docs/reference/view-configuration-model.md` |
