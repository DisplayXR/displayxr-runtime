...
struct xrt_display_processor_d3d12
{
	 ...
	 */
	bool (*get_background_preview)(struct xrt_display_processor_d3d12 *xdp,
...
XRT_DP_ABI_ASSERT(offsetof(struct xrt_display_processor_d3d12, get_background_preview) == XRT_DP_D3D12_BASE_OFF + 23 * sizeof(void *), XRT_DP_ABI_MSG);
XRT_DP_ABI_ASSERT(sizeof(struct xrt_display_processor_d3d12)                                == XRT_DP_D3D12_BASE_OFF + 24 * sizeof(void *), XRT_DP_ABI_MSG);
 ...
 */
#define XRT_DP_D3D12_HAS_BACKGROUND_PREVIEW 1
...
/*!
 * @copydoc xrt_display_processor_d3d12::get_background_preview
 *
 ...
 */
static inline bool
xrt_display_processor_d3d12_get_background_preview(struct xrt_display_processor_d3d12 *xdp,
                                                   struct xrt_dp_background_preview *out_preview)
{
