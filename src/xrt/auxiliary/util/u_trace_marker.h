...
// Markers for sub-zones within a Vulkan marked zone.
#define VK_TRACE_IDENT_SUBZONE1(IDENT) U_TRACE_IDENT_COLOR(comp, IDENT, 0x491556)
#define VK_TRACE_IDENT_SUBZONE2(IDENT) U_TRACE_IDENT_COLOR(comp, IDENT, 0x324ff2)
#define VK_TRACE_IDENT_SUBZONE3(IDENT) U_TRACE_IDENT_COLOR(comp, IDENT, 0xabc9c8)
#define VK_TRACE_IDENT_SUBZONE4(IDENT) U_TRACE_IDENT_COLOR(comp, IDENT, 0xc12a8a)
...
// Markers for sub-zones within a driver marked zone.
#define XRT_TRACE_IDENT_SUBZONE1(IDENT) U_TRACE_IDENT_COLOR(comp, IDENT, 0x1e1447)
#define XRT_TRACE_IDENT_SUBZONE2(IDENT) U_TRACE_IDENT_COLOR(comp, IDENT, 0x404444)
#define XRT_TRACE_IDENT_SUBZONE3(IDENT) U_TRACE_IDENT_COLOR(comp, IDENT, 0x0c080b)
#define XRT_TRACE_IDENT_SUBZONE4(IDENT) U_TRACE_IDENT_COLOR(comp, IDENT, 0xeff9d6)
...
// Markers for sub-zones within a driver marked zone.
#define DRV_TRACE_IDENT_SUBZONE1(IDENT) U_TRACE_IDENT_COLOR(comp, IDENT, 0x000107)
#define DRV_TRACE_IDENT_SUBZONE2(IDENT) U_TRACE_IDENT_COLOR(comp, IDENT, 0xc9bad3)
#define DRV_TRACE_IDENT_SUBZONE3(IDENT) U_TRACE_IDENT_COLOR(comp, IDENT, 0x1bb4ba)
#define DRV_TRACE_IDENT_SUBZONE4(IDENT) U_TRACE_IDENT_COLOR(comp, IDENT, 0x05080a)
...
// Markers for sub-zones within a IPC marked zone.
#define IPC_TRACE_IDENT_SUBZONE1(IDENT) U_TRACE_IDENT_COLOR(comp, IDENT, 0xc934d3)
#define IPC_TRACE_IDENT_SUBZONE2(IDENT) U_TRACE_IDENT_COLOR(comp, IDENT, 0x010f05)
#define IPC_TRACE_IDENT_SUBZONE3(IDENT) U_TRACE_IDENT_COLOR(comp, IDENT, 0x050707)
#define IPC_TRACE_IDENT_SUBZONE4(IDENT) U_TRACE_IDENT_COLOR(comp, IDENT, 0x0c0108)
...
// Markers for sub-zones within a OpenXR marked zone.
#define OXR_TRACE_IDENT_SUBZONE1(IDENT) U_TRACE_IDENT_COLOR(comp, IDENT, 0xb06044)
#define OXR_TRACE_IDENT_SUBZONE2(IDENT) U_TRACE_IDENT_COLOR(comp, IDENT, 0xe8e7e5)
#define OXR_TRACE_IDENT_SUBZONE3(IDENT) U_TRACE_IDENT_COLOR(comp, IDENT, 0x135584)
#define OXR_TRACE_IDENT_SUBZONE4(IDENT) U_TRACE_IDENT_COLOR(comp, IDENT, 0x20eac5)
...
// Markers for sub-zones within a compositor marked zone.
#define COMP_TRACE_IDENT_SUBZONE1(IDENT) U_TRACE_IDENT_COLOR(comp, IDENT, 0xff2312)
#define COMP_TRACE_IDENT_SUBZONE2(IDENT) U_TRACE_IDENT_COLOR(comp, IDENT, 0x2312ff)
#define COMP_TRACE_IDENT_SUBZONE3(IDENT) U_TRACE_IDENT_COLOR(comp, IDENT, 0x33a012)
#define COMP_TRACE_IDENT_SUBZONE4(IDENT) U_TRACE_IDENT_COLOR(comp, IDENT, 0x88a0d2)
...
// Markers for sub-zones within a sink marked zone.
#define SINK_TRACE_IDENT_SUBZONE1(IDENT) U_TRACE_IDENT_COLOR(comp, IDENT, 0x898368)
#define SINK_TRACE_IDENT_SUBZONE2(IDENT) U_TRACE_IDENT_COLOR(comp, IDENT, 0x026d09)
#define SINK_TRACE_IDENT_SUBZONE3(IDENT) U_TRACE_IDENT_COLOR(comp, IDENT, 0xa6eda1)
#define SINK_TRACE_IDENT_SUBZONE4(IDENT) U_TRACE_IDENT_COLOR(comp, IDENT, 0x233f93)
...
// Markers for sub-zones within a swap chain marked zone.
#define SWAPCHAIN_TRACE_IDENT_SUBZONE1(IDENT) U_TRACE_IDENT_COLOR(comp, IDENT, 0xa4a4f2)
#define SWAPCHAIN_TRACE_IDENT_SUBZONE2(IDENT) U_TRACE_IDENT_COLOR(comp, IDENT, 0x376349)
#define SWAPCHAIN_TRACE_IDENT_SUBZONE3(IDENT) U_TRACE_IDENT_COLOR(comp, IDENT, 0xa0766a)
#define SWAPCHAIN_TRACE_IDENT_SUBZONE4(IDENT) U_TRACE_IDENT_COLOR(comp, IDENT, 0xacdce0)
...
// Markers for sub-zones within a track marked zone.
#define TRACK_TRACE_IDENT_SUBZONE1(IDENT) U_TRACE_IDENT_COLOR(comp, IDENT, 0x384949)
#define TRACK_TRACE_IDENT_SUBZONE2(IDENT) U_TRACE_IDENT_COLOR(comp, IDENT, 0x373d1e)
#define TRACK_TRACE_IDENT_SUBZONE3(IDENT) U_TRACE_IDENT_COLOR(comp, IDENT, 0x053d37)
#define TRACK_TRACE_IDENT_SUBZONE4(IDENT) U_TRACE_IDENT_COLOR(comp, IDENT, 0x0b223f)
