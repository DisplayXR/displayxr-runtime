...
class MonadoOpenXrUiProvider @Inject constructor(@ApplicationContext val context: Context) :
    ...
    override fun getNotificationIcon(): Icon? =
        Icon.createWithResource(context, R.drawable.ic_displayxr_fg)

    /** Make a {@code PendingIntent} to launch the diagnostics dashboard (#558). */
    override fun makeAboutActivityPendingIntent(): PendingIntent {
        ...
        return PendingIntent.getActivity(
            ...
            Intent.makeMainActivity(
                ComponentName.createRelative(context, DashboardActivity::class.qualifiedName!!)
            ),
            flags,
        )
    }
