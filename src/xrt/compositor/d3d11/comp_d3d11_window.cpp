...
wnd_proc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_SETCURSOR:
		...
		// (spec_version 12, ADR-018 / PR D of the runtime->controller
		// migration). Win32 keeps tracking the cursor position for
		// hit-test, drag operations, and event delivery — only the
