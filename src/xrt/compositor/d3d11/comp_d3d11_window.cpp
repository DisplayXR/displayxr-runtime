...
#ifdef XRT_BUILD_DRIVER_QWERTY
		// When bridge is active, don't forward keys to qwerty — mode
		// changes go through the app-initiated HWND property relay.
		// Consume all keys (return 0) so DefWindowProc doesn't process
		// them. The bridge's LL hook captures them for the sample.
