...
static xrt_result_t
client_d3d12_compositor_layer_window_space(struct xrt_compositor *xc,
                                           struct xrt_device *xdev,
                                           struct xrt_swapchain *xsc,
                                           const struct xrt_layer_data *data)
{
...
static xrt_result_t
client_d3d12_compositor_layer_zone_3d(struct xrt_compositor *xc,
                                      struct xrt_device *xdev,
                                      struct xrt_swapchain *xsc[XRT_MAX_VIEWS],
                                      const struct xrt_layer_data *data)
{
...
try {
	...
	c->base.base.layer_zone_3d = client_d3d12_compositor_layer_zone_3d;
