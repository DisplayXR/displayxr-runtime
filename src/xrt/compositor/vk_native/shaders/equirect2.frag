...
//
// XR_KHR_composition_layer_equirect2 fragment shader (#1602), sampler2D source.
//
...
// _SRGB (#1589).
//
// Kept in step with its equirect2_array.frag twin by hand; they differ only in the sampler
// declaration and DXR_EQ2_SAMPLE.

#version 450

layout(binding = 0) uniform sampler2D src_tex;
#define DXR_EQ2_SAMPLE(uv) texture(src_tex, uv)
