...
oxr_ref_space_to_xr(enum oxr_space_type space_type)
{
	...
	case OXR_SPACE_TYPE_REFERENCE_DISPLAY_EXT: return XR_REFERENCE_SPACE_TYPE_DISPLAY_EXT;
...
xr_ref_space_to_oxr(XrReferenceSpaceType space_type)
{
	...
	case XR_REFERENCE_SPACE_TYPE_DISPLAY_EXT: return OXR_SPACE_TYPE_REFERENCE_DISPLAY_EXT;
...
xr_ref_space_to_string(XrReferenceSpaceType space_type)
{
	...
	case XR_REFERENCE_SPACE_TYPE_DISPLAY_EXT: return "XR_REFERENCE_SPACE_TYPE_DISPLAY_EXT";
...
oxr_ref_space_to_xrt(enum oxr_space_type space_type)
{
	...
	case OXR_SPACE_TYPE_REFERENCE_DISPLAY_EXT: return XRT_SPACE_REFERENCE_TYPE_DISPLAY;
...
xr_ref_space_to_xrt(XrReferenceSpaceType space_type)
{
	...
	case XR_REFERENCE_SPACE_TYPE_DISPLAY_EXT: return XRT_SPACE_REFERENCE_TYPE_DISPLAY;
