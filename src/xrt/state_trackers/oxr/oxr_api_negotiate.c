...
#endif
#ifdef OXR_HAVE_EXT_android_surface_binding
	ENTRY_IF_EXT(xrSetSharedTextureOutputRectEXT, EXT_android_surface_binding);
	ENTRY_IF_EXT(xrSetSharedTextureSurround2DEXT, EXT_android_surface_binding);
#endif
