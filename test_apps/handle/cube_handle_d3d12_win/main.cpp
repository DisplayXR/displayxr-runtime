...
/*!
 * @file
 * @brief  SR Cube OpenXR Ext D3D12 - OpenXR with XR_DXR_win32_window_binding (D3D12)
 *
                        ...
                        if (rendered && inputSnapshot.hudVisible && hud && xr->hasHudSwapchain && hudSwapchainImages) {
                            ...
                            if (AcquireHudSwapchainImage(*xr, hudImageIndex)) {
                                ...
                                std::wstring modeText = xr->hasWin32WindowBindingExt ?
                                    L"XR_DXR_win32_window_binding: ACTIVE (D3D12)" :
                                    L"XR_DXR_win32_window_binding: NOT AVAILABLE (D3D12)";
