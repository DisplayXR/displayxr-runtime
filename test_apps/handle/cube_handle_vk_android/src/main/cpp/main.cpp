...
push_window_geometry()
{
	...
	LOGI("window screen rect: %d,%d %dx%d (logical %dx%d) panel %dx%d display %d -> %d", r.x, r.y, pub_w,
	     pub_h, r.w, r.h, r.panel_w, r.panel_h, r.display_id, (int)res);
}
#endif
...
#if defined(CUBE_HAVE_ANDROID_SURFACE_BINDING) && defined(XR_TYPE_EVENT_DATA_ANDROID_WINDOW_LAYOUT_HINT_DXR)
 ...
 * classloader-fragile (#507).
 *
 * @param out int[2] receiving layout width/height when this returns true.
 */
extern "C" JNIEXPORT jboolean JNICALL
Java_com_displayxr_cube_1handle_1vk_1android_MainActivity_nativeGetWindowLayoutRequest(
