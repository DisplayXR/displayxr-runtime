...
/*!
 * @file
 * @brief  Cube Zones VK — XR_EXT_display_zones exerciser (ADR-027),
...
static const wchar_t* WINDOW_TITLE = L"Vulkan Cube Zones — XR_EXT_display_zones (array/SPI)";
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow) {
    ...
    LOG_INFO("=== Cube Zones VK (XR_EXT_display_zones, array/SPI) ===");
