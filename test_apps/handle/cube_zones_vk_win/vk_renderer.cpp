...
// Textured cube fragment shader: lighting matches cube_handle_gl_win /
// cube_handle_metal_macos / cube_handle_gl_macos.
//
// ADR-021 / INV-4.6: the `uLinearize` specialization constant (SpecId 0) adds
// the standard sRGB EOTF to the emitted colour. The cube's authored colours and
// its basecolor/AO textures are DISPLAY-REFERRED (VK_FORMAT_R8G8B8A8_UNORM,
// authored for a UNORM pass-through swapchain). When the colour swapchain is
// `_SRGB` the attachment encodes on write, so emitting those numbers raw would
// encode them twice (washed out). Decoding here makes the round-trip an
// identity: the bytes stored in the `_SRGB` swapchain are EXACTLY the bytes the
// UNORM path stored, and they are now honestly declared as encoded. The
// constant is specialized at pipeline-creation time from
// dxr::RenderSceneLinear() -- InitializeVkRenderer() runs after
// CreateSwapchain(), so the noted format is already authoritative.
//
...
static const uint32_t g_cubeTexturedFragSpv[] = {
    0x07230203,0x00010000,0x0008000b,0x00000081,0x00000000,0x00020011,
    0x00000001,0x0006000b,0x00000001,0x4c534c47,0x6474732e,0x3035342e,
    ...
    0x0000007b,0x00030010,0x00000004,0x00000007,0x00030003,0x00000002,
    ...
    0x746e6567,0x00000000,0x00030005,0x00000035,0x004e4254,0x00040005,
    0x00000049,0x6d726f6e,0x00006c61,0x00050005,0x0000004e,0x6867696c,
    0x72694474,0x00000000,0x00040005,0x00000053,0x66666964,0x00657375,
    0x00030005,0x0000005c,0x006c6f63,0x00050005,0x00000063,0x6e694c75,
    0x69726165,0x0000657a,0x00050005,0x0000007b,0x4374756f,0x726f6c6f,
    ...
    0x00000000,0x00040047,0x00000017,0x00000021,0x00000001,0x00040047,
    0x00000017,0x00000022,0x00000000,0x00040047,0x00000023,0x00000021,
    0x00000002,0x00040047,0x00000023,0x00000022,0x00000000,0x00040047,
    0x0000002c,0x0000001e,0x00000001,0x00040047,0x00000030,0x0000001e,
    0x00000002,0x00040047,0x00000063,0x00000001,0x00000000,0x00040047,
    0x0000007b,0x0000001e,0x00000000,0x00020013,0x00000002,0x00030021,
    ...
    0x00000007,0x00090019,0x0000000a,0x00000006,0x00000001,0x00000000,
    ...
    0x00000010,0x00000011,0x00000001,0x00040017,0x00000013,0x00000006,
    0x00000004,0x0004003b,0x0000000c,0x00000017,0x00000000,0x0004002b,
    0x00000006,0x0000001c,0x40000000,0x0004002b,0x00000006,0x0000001e,
    0x3f800000,0x00040020,0x00000021,0x00000007,0x00000006,0x0004003b,
    0x0000000c,0x00000023,0x00000000,0x00040015,0x00000027,0x00000020,
    0x00000000,0x0004002b,0x00000027,0x00000028,0x00000000,0x00040020,
    0x0000002b,0x00000001,0x00000007,0x0004003b,0x0000002b,0x0000002c,
    0x00000001,0x0004003b,0x0000002b,0x00000030,0x00000001,0x00040018,
    0x00000033,0x00000007,0x00000003,0x00040020,0x00000034,0x00000007,
    0x00000073,0x0000006f,0x0003003e,0x0000005c,0x00000079,0x000200f9,
    0x00000065,0x000200f8,0x00000065,0x0004003d,0x00000007,0x0000007c,
    0x0000005c,0x00050051,0x00000006,0x0000007d,0x0000007c,0x00000000,
    0x00050051,0x00000006,0x0000007e,0x0000007c,0x00000001,0x00050051,
    0x00000006,0x0000007f,0x0000007c,0x00000002,0x00070050,0x00000013,
    0x00000080,0x0000007d,0x0000007e,0x0000007f,0x0000001e,0x0003003e,
    0x0000007b,0x00000080,0x000100fd,0x00010038,
};
...
// Grid fragment shader (GLSL 450). Same `uLinearize` rule as the cube FS: the
// grid colour arrives display-referred through the push constant, so it must be
// decoded when the attachment will encode on write -- otherwise the grid (and
// every other constant-colour draw) brightens on an `_SRGB` swapchain while the
// textured cube stays put.
//
    ...
    VkQueue queue, uint32_t queueFamilyIndex, VkFormat colorFormat)
{
    ...
    // displayxr-common v2.15.0 default) => the attachment encodes on write =>
    // the shaders must hand it decoded (linear) values, or the authored
    // display-referred colour gets encoded twice and washes out.
    // DXR_TRUE_LINEAR overrides in both directions (see color_policy.h).
    ...
    // Load textures
    {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            // Full mip chain so the wood texture stays smooth under
            ...
            // Generate the mip chain: blit each level down to the next, then
            // leave every level in SHADER_READ_ONLY. All levels start in
            // TRANSFER_DST (the barrier above covered levelCount = mipLevels).
            ...
            for (uint32_t level = 1; level < mipLevels; level++) {
                ...
                vkCmdBlitImage(renderer.commandBuffer,
                    renderer.texImages[i], VK_IMAGE_LAYOUT_TRANSFER_SRC_OPTIMAL,
                    renderer.texImages[i], VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL,
                    1, &blit, VK_FILTER_LINEAR);

                // Source level done: TRANSFER_SRC -> SHADER_READ.
    ...
    float zoomScale)
{
    ...
    // background above would come out visibly brighter than it does on a UNORM
    // target, and brighter than the cube drawn over it. Decode it here for
    // exactly the same reason the fragment shaders decode, off the SAME latched
    // flag the pipelines were specialized with. Alpha is linear in both spaces
    // and is never converted. (Mirrors the D3D11 reference renderer's
    // ClearRenderTargetViewDisplayReferred().)
...
{
    VkDevice device = renderer.device;
    fb.imageCount = imageCount;
    fb.layers = layerCount;
    fb.width = width;
    fb.height = height;
    fb.colorViews.resize((size_t)imageCount * layerCount);
    fb.framebuffers.resize((size_t)imageCount * layerCount);

    // One shared, single-layer depth image (per-view tile sized). The render
    // pass CLEARs it at the start of every layer submission, so serial reuse
    // across (image, layer) is safe.
    {
        VkImageCreateInfo imageInfo = {};
        imageInfo.sType = VK_STRUCTURE_TYPE_IMAGE_CREATE_INFO;
        imageInfo.imageType = VK_IMAGE_TYPE_2D;
        ...
        imageInfo.tiling = VK_IMAGE_TILING_OPTIMAL;
        imageInfo.usage = VK_IMAGE_USAGE_DEPTH_STENCIL_ATTACHMENT_BIT;
        if (vkCreateImage(device, &imageInfo, nullptr, &fb.depthImage) != VK_SUCCESS) {
            LOG_ERROR("[zones] Failed to create zone-array depth image (%ux%u)", width, height);
            return false;
        }

        VkMemoryRequirements memReqs;
        vkGetImageMemoryRequirements(device, fb.depthImage, &memReqs);
        VkMemoryAllocateInfo allocInfo = {};
        allocInfo.sType = VK_STRUCTURE_TYPE_MEMORY_ALLOCATE_INFO;
        allocInfo.allocationSize = memReqs.size;
        allocInfo.memoryTypeIndex = FindMemoryType(renderer.physicalDevice, memReqs.memoryTypeBits,
            VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT);
        if (vkAllocateMemory(device, &allocInfo, nullptr, &fb.depthMemory) != VK_SUCCESS) {
            LOG_ERROR("[zones] Failed to allocate zone-array depth memory");
            return false;
        }
        vkBindImageMemory(device, fb.depthImage, fb.depthMemory, 0);

        VkImageViewCreateInfo dv = {};
        dv.sType = VK_STRUCTURE_TYPE_IMAGE_VIEW_CREATE_INFO;
        dv.image = fb.depthImage;
        dv.viewType = VK_IMAGE_VIEW_TYPE_2D;
        dv.format = VK_FORMAT_D32_SFLOAT;
        dv.subresourceRange.aspectMask = VK_IMAGE_ASPECT_DEPTH_BIT;
        dv.subresourceRange.baseMipLevel = 0;
        dv.subresourceRange.levelCount = 1;
        dv.subresourceRange.baseArrayLayer = 0;
        dv.subresourceRange.layerCount = 1;
        if (vkCreateImageView(device, &dv, nullptr, &fb.depthView) != VK_SUCCESS) {
            LOG_ERROR("[zones] Failed to create zone-array depth view");
            return false;
        }
    }

    // One color view + framebuffer per (image, layer): the color view targets a
    // SINGLE array layer (baseArrayLayer = layer, layerCount = 1) so each view
    // renders into its own slice — the Vulkan analogue of the D3D12 per-slice
    // TEXTURE2DARRAY RTV.
    for (uint32_t img = 0; img < imageCount; img++) {
        for (uint32_t layer = 0; layer < layerCount; layer++) {
            ...
            cv.subresourceRange.aspectMask = VK_IMAGE_ASPECT_COLOR_BIT;
            cv.subresourceRange.baseMipLevel = 0;
            cv.subresourceRange.levelCount = 1;
            cv.subresourceRange.baseArrayLayer = layer;
            cv.subresourceRange.layerCount = 1;

            const size_t idx = (size_t)img * layerCount + layer;
            if (vkCreateImageView(device, &cv, nullptr, &fb.colorViews[idx]) != VK_SUCCESS) {
                LOG_ERROR("[zones] Failed to create zone-array color view img=%u layer=%u", img, layer);
                return false;
            }

            VkImageView attachments[] = {fb.colorViews[idx], fb.depthView};
            VkFramebufferCreateInfo fbInfo = {};
            fbInfo.sType = VK_STRUCTURE_TYPE_FRAMEBUFFER_CREATE_INFO;
            fbInfo.renderPass = renderer.renderPass;
            fbInfo.attachmentCount = 2;
            ...
            fbInfo.height = height;
            fbInfo.layers = 1;
            if (vkCreateFramebuffer(device, &fbInfo, nullptr, &fb.framebuffers[idx]) != VK_SUCCESS) {
                LOG_ERROR("[zones] Failed to create zone-array framebuffer img=%u layer=%u", img, layer);
                return false;
            }
        }
    }

    LOG_INFO("[zones] Created %u zone-array framebuffers (%u images x %u layers, %ux%u/view)",
             imageCount * layerCount, imageCount, layerCount, width, height);
    return true;
}
    ...
    const float clearColor[4], float rotationOffset)
{
    ...
    // Per-zone premultiplied clear (zone A opaque tint; zone B fully transparent
    // -> desktop show-through; matches the D3D11/D3D12/macOS zones apps).
    VkClearValue clearValues[2] = {};
    clearValues[0].color = {{clearColor[0], clearColor[1], clearColor[2], clearColor[3]}};
    // ADR-021 / INV-4.6: the per-zone clear colour is authored
    // DISPLAY-REFERRED, and VkClearColorValue is taken in the attachment's own
    // space, so an `_SRGB` zone attachment would encode it and the tint would
    // come out brighter than the cube drawn over it. Decode off the same latched
    // flag the pipelines were specialized with; alpha (premultiplication) is
    // linear in both spaces and is never converted. Mirrors the D3D11 zones app
    // (ClearRenderTargetViewDisplayReferred).
    if (renderer.sceneLinear) {
        for (int i = 0; i < 3; i++) {
            clearValues[0].color.float32[i] =
    ...
    const size_t idx = (size_t)imageIndex * fb.layers + layer;
    VkRenderPassBeginInfo rpBegin = {};
    rpBegin.sType = VK_STRUCTURE_TYPE_RENDER_PASS_BEGIN_INFO;
    rpBegin.renderPass = renderer.renderPass;
    rpBegin.framebuffer = fb.framebuffers[idx];
    rpBegin.renderArea.offset = {0, 0};
    rpBegin.renderArea.extent = {fb.width, fb.height};
    rpBegin.clearValueCount = 2;
    rpBegin.pClearValues = clearValues;
    vkCmdBeginRenderPass(renderer.commandBuffer, &rpBegin, VK_SUBPASS_CONTENTS_INLINE);

    const float zoneRotation = renderer.cubeRotation + rotationOffset;

    // Full-viewport into the tile (Y-flip via negative height for NDC).
    const uint32_t w = fb.width;
    const uint32_t h = fb.height;
    XMMATRIX viewMatrix = eye.viewMatrix;
    XMMATRIX projMatrix = eye.projMatrix;
    ...
    // Draw cube - base rests on grid at y=0 (per-zone spin phase applied).
    {
        const float cubeSize = 0.06f;
        const float cubeHeight = cubeSize / 2.0f;
        XMMATRIX cubeScale = XMMatrixScaling(cubeSize, cubeSize, cubeSize);
        XMMATRIX cubeRot = XMMatrixRotationY(zoneRotation);
        XMMATRIX cubeTrans = XMMatrixTranslation(0.0f, cubeHeight, 0.0f);
        XMMATRIX cubeWVP = cubeRot * cubeScale * cubeTrans * viewMatrix * projMatrix;
    ...
    // Draw grid floor.
    {
        ...
        XMMATRIX gridWorld = XMMatrixScaling(gridScale, gridScale, gridScale)
                           * XMMatrixTranslation(0, gridScale, 0);
        XMMATRIX gridWVP = gridWorld * viewMatrix * projMatrix;
    ...
    // Wait for completion before returning - the runtime needs the zone image
    // ready when the projection layer referencing it is submitted in xrEndFrame.
    vkWaitForFences(device, 1, &renderer.frameFence, VK_TRUE, UINT64_MAX);
}
...
void DestroyZoneArrayFramebuffers(VkRenderer& renderer, ZoneArrayFramebuffers& fb) {
    ...
    for (auto f : fb.framebuffers) {
        if (f != VK_NULL_HANDLE) vkDestroyFramebuffer(renderer.device, f, nullptr);
    }
    fb.framebuffers.clear();
    for (auto v : fb.colorViews) {
        if (v != VK_NULL_HANDLE) vkDestroyImageView(renderer.device, v, nullptr);
    }
    fb.colorViews.clear();
    ...
    if (fb.depthMemory != VK_NULL_HANDLE) {
        vkFreeMemory(renderer.device, fb.depthMemory, nullptr);
        fb.depthMemory = VK_NULL_HANDLE;
    }
}
