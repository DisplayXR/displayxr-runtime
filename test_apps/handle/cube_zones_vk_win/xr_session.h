 ...
 * presentation via XR_DXR_win32_window_binding + the VK native compositor) and
 * extended with XR_DXR_display_zones (ADR-027) detection + entry points,
 * mirroring the D3D12 handle-class zones reference cube_zones_d3d12_win. The
 * zones extension composes XR_DXR_local_3d_zone (the wish-mask tiers) and
