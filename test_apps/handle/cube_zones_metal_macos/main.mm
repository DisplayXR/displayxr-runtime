...
/*!
 * @file
 * @brief  Cube Zones Metal — XR_DXR_display_zones exerciser (ADR-027), macOS leg
 *
...
static bool CreateMacOSWindow(uint32_t width, uint32_t height, int32_t screenLeft, int32_t screenTop)
{
    @autoreleasepool {
        ...
        [g_window setTitle:@"Metal Cube Zones — XR_DXR_display_zones"];
...
int main(int argc, char **argv)
{
    ...
    LOG_INFO("=== Metal Cube Zones OpenXR (XR_DXR_display_zones, ADR-027) ===");
