...
bool InitializeOpenXR(XrSessionManager& xr) {
    ...
    if (!xr.hasWin32WindowBindingExt) {
        ...
        LOG_ERROR("XR_EXT_win32_window_binding extension not available - shared texture mode impossible");
    }
    ...
    // XrDisplayZonesFrameEndInfoEXT. pfnAcquire is optional — without it wish
    ...
    HANDLE sharedTextureHandle, HWND appHwnd)
{
    ...
    if (xr.hasWin32WindowBindingExt && appHwnd && sharedTextureHandle) {
        ...
        LOG_INFO("  Chain: XrSessionCreateInfo -> XrGraphicsBindingVulkanKHR -> XrWin32WindowBindingCreateInfoEXT");
    } else {
