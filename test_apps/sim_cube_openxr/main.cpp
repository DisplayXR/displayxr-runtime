...
/*!
 * @file
 * @brief  Cross-platform Vulkan OpenXR spinning cube test app
 *
...
// Cube vertex shader: layout(push_constant) uniform PC { mat4 transform; vec4 color; } pc;
...
//   layout(location=0) in vec4 vColor; layout(location=0) out vec4 FragColor;
