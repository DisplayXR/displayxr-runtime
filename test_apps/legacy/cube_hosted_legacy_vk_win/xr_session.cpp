...
/*!
 * @file
 * @brief  OpenXR session management for Vulkan (legacy mode — no XR_DXR_display_info)
 *
...
bool InitializeOpenXR(XrSessionManager& xr) {
    ...
    // Legacy: only enable Vulkan — no display info, no window binding
    ...
    strcpy_s(createInfo.applicationInfo.applicationName, "SRCubeVK_Legacy");
...
bool CreateVulkanInstance(XrSessionManager& xr, VkInstance& vkInstance) {
    ...
    appInfo.pApplicationName = "SRCubeVK";
