                    ...
                    if (LocateViews(*xr, frameState.predictedDisplayTime,
                        ...
                        if (useAppProjection) {
                            ...
                            if (inputSnapshot.cameraMode) {
                                ...
                                camTunables.ipd_factor = inputSnapshot.stereo.ipdFactor;
                                camTunables.parallax_factor = inputSnapshot.stereo.parallaxFactor;
                                camTunables.inv_convergence_distance = inputSnapshot.stereo.invConvergenceDistance;
                                camTunables.half_tan_vfov = CAMERA_HALF_TAN_VFOV / inputSnapshot.stereo.zoomFactor;
                        ...
                        if (rendered && inputSnapshot.hudVisible && hud && xr->hasHudSwapchain && hudSwapchainImages) {
                            ...
                            if (AcquireHudSwapchainImage(*xr, hudImageIndex)) {
                                ...
                                float dispP1 = inputSnapshot.cameraMode ? inputSnapshot.stereo.invConvergenceDistance : inputSnapshot.stereo.perspectiveFactor;
                                float dispP2 = inputSnapshot.cameraMode ? inputSnapshot.stereo.zoomFactor : inputSnapshot.stereo.scaleFactor;
                                    ...
                                    dispP1, dispP2, inputSnapshot.cameraMode);
                                {
                                    wchar_t vhBuf[64];
                                    if (inputSnapshot.cameraMode) {
                                        float tanHFOV = CAMERA_HALF_TAN_VFOV / inputSnapshot.stereo.zoomFactor;
                                        swprintf(vhBuf, 64, L"\ntanHFOV: %.3f", tanHFOV);
                                    } else {
                                        float hudM2v = 1.0f;
                                        if (inputSnapshot.stereo.virtualDisplayHeight > 0.0f && xr->displayHeightM > 0.0f)
                                ...
                                std::wstring helpText = FormatHelpText(xr->pfnRequestDisplayRenderingModeEXT != nullptr, inputSnapshot.cameraMode);
