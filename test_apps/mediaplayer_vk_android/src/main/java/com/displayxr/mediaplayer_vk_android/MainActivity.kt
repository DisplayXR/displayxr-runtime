...
class MainActivity : NativeActivity() {
    ...
    // Brief on-screen banner naming the demo. Shown once per launch a couple
    // seconds in, after first light. A Toast sits above the weave overlay, so
    // no Vulkan HUD work is needed for a transient hint. (Stage 3 will grow this
    // into real playback controls.)
