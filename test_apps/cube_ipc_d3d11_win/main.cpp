...
/*!
 * @file
 * @brief  SR Cube OpenXR - IPC mode (spatial shell foundation)
 *
 * IPC variant: runs out-of-process via client compositor → IPC → service.
 * Extension app: enables XR_EXT_display_info for full mode enumeration.
 *
 ...
 *
 * Use case: foundation for multi-app spatial shell (#43, #44).
 *
...
static const char* APP_NAME = "cube_ipc_d3d11_win";
